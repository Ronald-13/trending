...
function HeartIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg fill="currentColor" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" className="octicon octicon-heart icon-sponsor mr-1 text-pink v-align-middle" {...props}>
